package com.zt.memcache.util.spring;
...
public class ZtVelocityViewResolver extends VelocityViewResolver {
	...
	/**
	 * Set a Velocity Toolbox domain.config location, for example "/WEB-INF/toolbox.xml",
	 * to automatically load a Velocity Tools toolbox definition file and expose
	 * all defined tools in the specified scopes. If no domain.config location is
	 ...
	 * <p><b>Note:</b> Specifying a toolbox domain.config location will lead to
